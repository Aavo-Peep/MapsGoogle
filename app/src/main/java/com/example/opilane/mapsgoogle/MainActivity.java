...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean ServicesOK(){
        ...
        int oigeVersioon = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(MainActivity
        .this);
        if (oigeVersioon == ConnectionResult.SUCCESS){
            ...
            Toast.makeText(this, "Kaardi päringute tegemine pole võimalik",
